...
driverContactRelationTableController.route('/org/driver/contact/relation-table/save').post((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const verifyRelationshipExists = yield new driverContactRelationTableService_1.default()
...
driverContactRelationTableController.route('/org/driver/contact/relation-table/get-all').get((req, res) => __awaiter(void 0, void 0, void 0, function* () {
