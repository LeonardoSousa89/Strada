...
driverDocumentRelationTableController.route('/org/driver/document/relation-table/save').post(async(req, res)=> {
    ...
    const verifyDriverDocumentIdExixts = await new DriverDocumentService()
    ...
    try{
        ...
        const driverAndDocumentRelation = new DriverDocumentRelationTableService(Driver.driver_document_relation_id,
