...
class OrgContactRelationTableService extends orgContactRelationTable_1.default {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            yield knex_1.default.insert(this.orgContactRelationTableService).from('vex_schema.org_contact_relation_table');
        });
    }
    update(id) {
    }
    getAll(size, page) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield knex_1.default.select('*').from('vex_schema.org_contact_relation_table');
            return data;
        });
    }
    getById(id) { }
