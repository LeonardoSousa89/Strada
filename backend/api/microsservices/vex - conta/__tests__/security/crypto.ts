...
export async function cipherOrgDataAndSave(data: any) {
 ...
 export async function cipherDriverDataAndSave(data: any) {
    ...
    const driverService = new DriverService(data.first_name,
                                            data.last_name,
                                            data.email,
                                            data.password)
 ...
 export async function decipherDriverDataAndGet() {
    ...
    for(let cipherDataPosition in data){
        ...
        data[cipherDataPosition].first_name = decipher(data[cipherDataPosition].first_name)
        data[cipherDataPosition].last_name = decipher(data[cipherDataPosition].last_name)
