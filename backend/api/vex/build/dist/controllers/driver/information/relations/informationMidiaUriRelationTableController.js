...
InformationMidiaUriRelationTableController.route("/org/driver/information/midia/uri/relation-table/delete/all").delete((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const InformationAndMidiaRelation = new informationMidiaUriRelationTableService_1.default();
    try {
