...
const saveOrg = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        err.exceptionFieldNullOrUndefined(Org.cnae_main_description, "cnae main description is undefined or null");
        err.exceptionFieldNullOrUndefined(Org.sector, "sector is undefined or null");
    ...
    try {
        ...
        const moment = new time_1.default().getTime();
...
const getOrgById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
