...
exports.deleteInformationMidiaUriRelationTableById = exports.deleteAllInformationMidiaUriRelationTable = exports.getInformationMidiaUriRelationTableById = exports.getInformationMidiaUriRelationTable = exports.saveInformationMidiaUriRelationTable = void 0;
...
const saveInformationMidiaUriRelationTable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.saveInformationMidiaUriRelationTable = saveInformationMidiaUriRelationTable;
const getInformationMidiaUriRelationTable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getInformationMidiaUriRelationTable = getInformationMidiaUriRelationTable;
const getInformationMidiaUriRelationTableById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getInformationMidiaUriRelationTableById = getInformationMidiaUriRelationTableById;
const deleteAllInformationMidiaUriRelationTable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const InformationAndMidiaRelation = new informationMidiaUriRelationTableService_1.default();
    try {
        const driverInfomationRelationExistsOrNotExists = yield InformationAndMidiaRelation.getAll();
        if (driverInfomationRelationExistsOrNotExists.length === 0)
            return res.status(404).json({
                error: "no data relationship",
            });
        yield InformationAndMidiaRelation.deleteAll();
...
exports.deleteAllInformationMidiaUriRelationTable = deleteAllInformationMidiaUriRelationTable;
const deleteInformationMidiaUriRelationTableById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const Driver = Object.assign({}, req.params);
    const InformationAndMidiaRelation = new informationMidiaUriRelationTableService_1.default();
    try {
...
exports.deleteInformationMidiaUriRelationTableById = deleteInformationMidiaUriRelationTableById;
