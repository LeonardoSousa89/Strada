    ...
    getAll(page, size) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let cipherDataPosition in data.data) {
                data.data[cipherDataPosition].first_name = this.cryptography.decrypt(data.data[cipherDataPosition].first_name);
                data.data[cipherDataPosition].last_name = this.cryptography.decrypt(data.data[cipherDataPosition].last_name);
