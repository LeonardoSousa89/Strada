...
class DriverAddressRelationTableService extends driverAddressRelationTable_1.default {
    ...
    getAll(size, page) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield knex_1.default
                .select(joinProjection_1.joinDriverAndAddressRelationProjection)
                .from("vex_schema.driver_address_relation_table");
            return data;
        });
    }
    ...
    deleteAll() {
        return __awaiter(this, void 0, void 0, function* () {
            yield knex_1.default.delete().from("vex_schema.driver_address_relation_table");
        });
    }
    deleteById(id) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.default = DriverAddressRelationTableService;
