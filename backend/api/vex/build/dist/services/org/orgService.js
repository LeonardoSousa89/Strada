    ...
    getAll(page, size) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let cipherDataPosition in data) {
                ...
                data[cipherDataPosition].cnae_main_description = this.cryptography.decrypt(data[cipherDataPosition].cnae_main_description);
                data[cipherDataPosition].sector = this.cryptography.decrypt(data[cipherDataPosition].sector);
                data[cipherDataPosition].account_created_at = this.cryptography.decrypt(data[cipherDataPosition].account_created_at);
            }
            return data;
        });
    }
