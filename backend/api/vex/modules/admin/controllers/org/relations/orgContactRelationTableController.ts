...
export const saveOrgContactRelationTable = async (req: any, res: any) => {
  const Org = { ...req.body };
...
export const getOrgContactRelationTable = async (req: any, res: any) => {
...
export const getOrgContactRelationTableById = async (req: any, res: any) => {
...
export const deleteOrgContactRelationTable = async (req: any, res: any) => {
  const orgContactRelationTableService = new OrgContactRelationTableService();
...
export const deleteOrgContactRelationTableById = async (req: any, res: any) => {
