...
export const saveInformationMidiaUriRelationTable = async (
  req: any,
  res: any
) => {
...
export const getInformationMidiaUriRelationTable = async (
  req: any,
  res: any
) => {
  const InformationAndMidiaRelation =
...
export const getInformationMidiaUriRelationTableById = async (
  req: any,
  res: any
) => {
...
export const deleteAllInformationMidiaUriRelationTable = async (
  req: any,
  res: any
) => {
  const InformationAndMidiaRelation =
...
export const deleteInformationMidiaUriRelationTableById = async (
  req: any,
  res: any
) => {
  const Driver = { ...req.params };
