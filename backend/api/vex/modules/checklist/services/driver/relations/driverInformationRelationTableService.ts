...
import { joinDriverAndInformationRelationProjection } from "../../../../admin/entities/org/projections/joinProjection";
  ...
  implements DbOperations
{
  ...
  async deleteAll() {
    await knex.delete().from("vex_schema.driver_information_relation_table");
  }
